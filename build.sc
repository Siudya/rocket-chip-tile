...
trait RocketChip
  ...
  object cdt extends CDT

  trait CDT extends CommonModule {
    override def millSourcePath = os.pwd / "rocket-chip" / "cdt"
  ...
  override def moduleDeps = super.moduleDeps ++ Seq(cdt)
}


object rocketgen extends SbtModule with ScalafmtModule with CommonModule {
